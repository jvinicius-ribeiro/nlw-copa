function createGame(player1, hour, player2) {
    return `
        <li>
            <img src="./assets/icons/${player1}.svg" alt="Bandeira do C${player1}">
            <strong>${hour}</strong>
...
document.querySelector("#cards").innerHTML =
    ...
    createCard("24/11", "quinta", 
        ...
        createGame("uruguay", "10:00", "south-kr") +
    ...
    createCard("28/11", "segunda", 
        ...
        createGame("south-kr", "10:00", "ghana") +
    ...
    createCard("02/12", "Sexta", 
        createGame("south-kr", "12:00", "portugal") +
